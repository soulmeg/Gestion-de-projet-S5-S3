<%-- 
    Document   : InsertionDureeFabricationProduit.jsp
    Created on : 16 janv. 2024, 13:56:25
    Author     : ASUS
--%>
...
<html>
    ...
    <body>
        ...
        <form action="/Baovola/InsertionDureeFabricationMeuble" method="post">
            <div class="container d-flex justify-content-center align-items-center" style="min-height: 70vh;">
            <div class="card" style="width: 20rem;">
               <div class="card-body">
                   <h5 class="card-title" style="text-align: center;">Durée de fabrication (par role)</h5>  
                    ...
                    <input class="form-control form-control-sm mb-3" name="duree" placeholder="Duree" type="text"  aria-label=".form-control-sm example"value="10"> Heure(s)
